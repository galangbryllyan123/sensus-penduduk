...
if (isset($_POST['username'])) {
  ...
  $MM_redirectLoginFailed = "gagal_admin.php";
  $MM_redirecttoReferrer = false;
  mysql_select_db($database_koneksi, $koneksi);
  
  $LoginRS__query=sprintf("SELECT username_admin, password_admin FROM pegawai WHERE username_admin=%s AND password_admin=%s",
...
<p>  <tr>
    <center>
      <td height="94" colspan="4"><img src="images/3.png" width="980" height="202" alt="title" /></td></center>
  </tr></p>
  <center><table width="500" height="200" border="0" bgcolor="#FF6600">
    <tr>        <h2><center>Login Admin</center></h2>
