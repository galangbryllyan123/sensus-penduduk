...
<div id="container">
	...
	<tr>
      ...
      <tr>
        <td><form name="form1" action="hitungkali_PPP.php" method="post"></td>
      </tr>
...
<input name="input1" type="text" class="col7" value="<?php
	...
	?>" maxlength="13" readonly='readonly' size="3">
      ...
      <tr>
        <td width="21%"><div align="left">Data 2</div></td>
        <td width="79%"><input name="input2" type="text" class="col7" value="100%" readonly='readonly' size="3"></td>
      </tr>
      <tr>
