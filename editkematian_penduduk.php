...
$query_r = "SELECT * FROM kematianpenduduk WHERE nomor = '$nomor'";
...
<title>Edit penduduk meninggal</title>
...
<div id="output">
  ...
  <div id="container">
    <div id="content">
      <h2>Edit Penduduk Meninggal </h2>
    </div>
	  <p>&nbsp;</p>
	  <p>&nbsp;</p>
	 <form action=update_kematianpenduduk.php method="POST" name="formedit" id="formedit">
      ...
      <form method="post" name="form1" action="<?php echo $editFormAction; ?>">
        ...
        <td width="74%"><div align="left"><?php echo $row[1];?></div></td>
		  ...
		  <tr valign="baseline">
            ...
            <td><p>&nbsp;
              ...
              <p><input name="NIK" type="text" class="col7" id='NIK' value="<?php echo $row[4];?>" size="25" readonly='readonly' maxlength="25" placeholder="NIK"></td>
	    </tr>
        <tr valign="baseline">
          <td nowrap align="right"><div align="left">Nama</div></td>
          <td><input name="nama" type="text" class="col7" id='nama' value="<?php echo $row[5];?>" size="32" readonly='readonly' maxlength="40" placeholder="Nama lengkap"></td>
          </tr>
        <tr valign="baseline">
          <td nowrap align="right"><div align="left">Tempat lahir</div></td>
          <td><input name="tempat_lahir" type="text" class="col7" id='tempat_lahir' value="<?php echo $row[6];?>" size="16" readonly='readonly' maxlength="20" placeholder="Tempat lahir"></td>
        <tr valign="baseline">
          <td nowrap align="right"><div align="left">Tanggal lahir</div></td>
          <td><input name="tanggal_lahir" type="date" class="col7" id='tanggal_lahir' value="<?php echo $row[7];?>" size="32" readonly='readonly'></td>
          </tr>
        <tr valign="baseline">
          <td nowrap align="right"><div align="left">Jenis kelamin</div></td>
          <td><input name="jenis_kelamin" type="text" class="col7" id='jenis_kelamin' value="<?php echo $row[8];?>" size="16" readonly='readonly' maxlength="20" placeholder="Jenis kelamin"></td>
			</tr>
		<tr valign="baseline">
        ...
        <tr valign="baseline">
          <tr valign="baseline">
            ...
            <td><input name="agama" type="text" class="col7" id='agama' value="<?php echo $row[9];?>" size="16" readonly='readonly' maxlength="15" placeholder="Agama"></td>
          </tr>
        <tr valign="baseline">
          <td nowrap align="right"><div align="left">Tempat meninggal</div></td>
          <td><input type="text" name="tempat_meninggal" value="<?php echo $row[10];?>" size="16" placeholder="Tempat meninggal" maxlength="30"></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right"><div align="left">Tanggal meninggal</div></td>
          <td><input type="date" name="tanggal_meninggal" value="<?php echo $row[11];?>" size="32" /></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right"><div align="left">Waktu meninggal</div></td>
          <td><input type="time" name="waktu_meninggal" value="<?php echo $row[12];?>" size="32"></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right"><div align="left">Sebab meninggal</div></td>
          <td><textarea name="sebab_meninggal" cols="50" rows="5" placeholder="Sebab meninggal" maxlength="50"><?php echo $row[13];?></textarea></td>
        </tr>
      <tr valign="baseline">
	<!-- ajax programming -->	  
        <?php  
