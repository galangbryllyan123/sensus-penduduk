...
<div id="output">
  ...
  <div id="container">
    <div id="content">
      ...
      <img class="imgl" src="images/sensus penduduk.jpg" alt="" width="125" height="125" />
      <p align="justify">Sensus penduduk sudah dilaksanakan  sejak 4000 tahun sebelum kristus, yaitu&nbsp; di Babylonia. Pada abad ke 16 dan  17 sensus dilaksanakan di Italia, Sisilia dan Spanyol untuk kepentingan  militer, pajak dan kerajaan. Sedangkan sensus modern dimulai di Quebec dan  Swedia di pertengahan abad ke 16. Di Indonesia sensus dimulai dimasa Raffles  pada tahun 1815.</p>
      <div align="justify">
        <p>Sensus penduduk atau cacah jiwa adalah proses  pencatatan, perhitungan, dan publikasi data demografis yang dilakukan terhadap  semua penduduk yang tinggal atau menetap di suatu wilayah tertentu  secara bersamaan.</p>
		<p>&nbsp;</p>
        <p>Di dalam  pelaksanaannya, sensus dapat dilakukan dengan dua cara, yaitu sebagai berikut :</p>
        <ul>
          <li>Sensus <em>de jure</em>, yaitu proses sensus penduduk penduduk yang dilaksanakan terhadap  semua orang yang benar - benar tercatat bertempat tinggal di suatu wilayah, umumnya berdasarkan dengan Kartu Tanda Penduduk ( KTP ).</li>
          <li>Sensus <em>de facto</em>, yaitu proses sensus penduduk yang dilaksanakan terhadap  semua orang yang ditemui oleh petugas ketika dilaksanakan sensus.</li>
        </ul>
      </div>
    </div>
	<div id="column">
      <div class="holder">
        <h2 class="title"><img src="images/cari1.png" width="44" height="46" />Sejarah singkat Desa Cimareme</h2>
        <p>Desa Cimareme adalah desa yang terletak Kecamatan Ngamprah, Kabupaten Bandung Barat, Provinsi Jawa Barat, Indonesia . . .</p>
		<p class="readmore">
		  <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=5,0,0,0" width="147" height="34">
            <param name="movie" value="button_sejarah.swf" />
            <param name="quality" value="high" />
            <embed src="button_sejarah.swf" quality="high" pluginspage="http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash" type="application/x-shockwave-flash" width="147" height="34" ></embed>
          </object>
	  </div>
	</div>
    <br class="clear" />
