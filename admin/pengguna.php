...
<div id="output">
  ...
  <div id="container">
    <div id="content">
      <h2>Pengguna</h2>
      <img src="images/user-icon-6.png" width="111" height="111" />
      <p align="justify">Pengguna adalah petugas lapangan sensus penduduk yang memiliki account dan password khusus untuk masuk kedalam aplikasi melalui proses login. </p>
      <div align="justify">
    </div>
    </div>
	<p>&nbsp;</p>
	...
	<form>
      <div align="right"><img src="images/cari1.png" width="44" height="28" border="0" />
          <input name="cari" type="text" placeholder="Nama" />
	...
	<table border="1" cellpadding="0" cellspacing="3">
      ...
      <?php do { ?>
        <tr>
          ...
          <td width="5%"><div align="center" onclick="MM_popupMsg('Data penduduk dihapus')">
            <div align="center"><a href="hapuspengguna.php?id=<?php echo $row_n['username']; ?>">Delete<img src="images/dell2.png" width="16" height="16" border="0"></a></div>
          </div></td>
        </tr>
        </tr>
