...
<div id="output">
  ...
  <div id="container">
    <div id="content">
      <h2>Struktur Organisasi Desa Cimareme</h2>
      <p align="justify">Struktur organisasi adalah suatu susunan komponen - komponen atau unit - unit kerja dalam sebuah organisasi dalam menjalankan kegiatan operasional untuk mencapai tujuan.&nbsp;Struktur organisasi menunjukkan adanya pembagian kerja dan menunjukkan bagaimana fungsi - fungsi atau kegiatan - kegiatan yang berbeda - beda tersebut diintegrasikan dan dikoordinasi. Struktur organisasi juga menunjukkan mengenai spesialisasi - spesialisasi dari pekerjaan, saluran perintah maupun penyampaian laporan.</p>
    </div>
    <div id="column">
      <div class="holder">
        <h2 class="title"><img src="images/cari1.png" width="44" height="46" />Wilayah Geografis</h2>
        <p>Wilayah geografis adalah  letak suatu daerah atau wilayah dilihat dari kenyataan di permukaan bumi . . .</p>
        <p class="readmore">
          <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=5,0,0,0" width="147" height="34">
            <param name="movie" value="button_geografis.swf" />
            <param name="quality" value="high" />
            <embed src="button_geografis.swf" quality="high" pluginspage="http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash" type="application/x-shockwave-flash" width="147" height="34" ></embed>
          </object>
        </p>
      </div>
    </div>
    <div align="center">
      ...
      <p><img src="images/Struktur Organisasi.jpg" width="647" height="376" /></p>
    </div>
  </div>
</div>
<!-- ####################################################################################################### -->
