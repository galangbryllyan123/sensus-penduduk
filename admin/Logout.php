...
<div id="container">
<tr>
    <th height="370" scope="col"><h2 align="center" class="style3">Apkah Anda yakin ingin keluar ?</h2>
      <form id="form1" name="form1" method="post" action="">
        <label>
        <center class="style2">
          <a type="submit" href="<?php echo $logoutAction ?>" class="style3 style2" title="">Logout,</a> <a type="submit" href="home.php" class="style3 style2" title="">Kembali</a>
        </center>
        </label>
      </form>	  </th>
  </tr>
