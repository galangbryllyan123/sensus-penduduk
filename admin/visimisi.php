...
<div id="output">
  ...
  <div id="container">
    <div id="content">
      <h2>Visi dan Misi Desa Cimareme</h2>
      <h1 align="center">Visi</h1>
      <p align="justify">Terbangunnya tata kelola pemerintahan desa yang baik, berdisiplin, bersih dan agamis guna mewujudkan Desa Cimareme yang adil, makmur, sejahtera dan agamis.</p>
      <h1 align="center">&nbsp;</h1>
      <h1 align="center">Misi</h1>
      <ul>
        <li>
          <p align="justify">Melakukan reformasi birokrasi di jajaran aparatur pemerintahan desa guna meningkatkan kualitas pelayanan kepada masyarakat.</p>
        </li>
        <li>
          <p align="justify">Meningkatkan perekonomian masyarakat.</p>
        </li>
        <li>
          <p align="justify">Meningkatkan mutu kesejahteraan masyarakat untuk mencapai taraf hidup yang lebih baik dan layak.</p>
        </li>
        <li>
          <p align="justify">Meningkatkan kerjasama yang lebih baik dengan unsur&nbsp; masyarakat, RT, RW, tokoh masyarakat, tokoh agama dan ormas untuk bersama - sama membangun Desa Cimareme lebih baik.</p>
        </li>
      </ul>
    </div>
	<div id="column">
      <div class="holder">
        <h2 class="title"><img src="images/cari1.png" width="44" height="46" />Struktur Organisasi</h2>
        <p>Struktur organisasi adalah suatu susunan komponen - komponen atau unit - unit kerja dalam sebuah organisasi . . .</p>
        <p class="readmore">
          <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=5,0,0,0" width="147" height="34">
            <param name="movie" value="button_struktur.swf" />
            <param name="quality" value="high" />
            <embed src="button_struktur.swf" quality="high" pluginspage="http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash" type="application/x-shockwave-flash" width="147" height="34" ></embed>
          </object>
        </p>
      </div>
    </div>
