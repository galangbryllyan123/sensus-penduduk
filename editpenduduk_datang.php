...
$query_r = "SELECT * FROM pendudukdatang WHERE nomor = '$nomor'";
...
<title>Edit penduduk datang</title>
      ...
      <form method="post" name="form1" action="<?php echo $editFormAction; ?>">
        ...
        <tr valign="baseline">
          ...
          <td><p>&nbsp;
            ...
            <p><input type="text" name="NIK" id="NIK" value="<?php echo $row[4]; ?>" size="25" maxlength="25"></p></td>
        </tr>
<tr valign="baseline">
          <td nowrap align="right"><div align="left">Nama</div></td>
          <td><input type="text" name="nama" id="nama" value="<?php echo $row[5]; ?>" size="32" maxlength="40"></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right"><div align="left">Tempat lahir</div></td>
          <td><input type="text" name="tempat_lahir" id="tempat_lahir" value="<?php echo $row[6]; ?>" size="16" maxlength="20"></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right"><div align="left">Tanggal lahir</div></td>
          <td><input type="date" name="tanggal_lahir" id="tanggal_lahir" value="<?php echo $row[7]; ?>" size="32"></td>
        </tr>
        <tr valign="baseline">
        ...
        <tr valign="baseline">
          ...
          <td><input type="text" name="hubungan_keluarga" id="hubungan_keluarga" value="<?php echo $row[10]; ?>" size="25" maxlength="20"></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right"><div align="left">Alasan datang</div></td>
          <td><input type="text" name="alasan_datang" id="alasan_datang" value="<?php echo $row[11]; ?>" size="32" maxlength="50"></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right" valign="top"><div align="left">Alamat tujuan</div></td>
          <td><textarea name="alamat_tujuan" cols="50" rows="5"><?php echo $row[12]; ?></textarea></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right"><div align="left">Tanggal datang</div></td>
          <td><input name="tanggal_datang" type="date" id="tanggal_datang" value="<?php echo $row[13]; ?>" size="32"></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right"><div align="left">Klasifikasi pindah</div></td>
          <td><select name="klasifikasi_pindah">
              <option value="Kecamatan" <?php if (!(strcmp("Kecamatan", $row[14]))) {echo "SELECTED";} ?>>Kecamatan</option>
              <option value="Kab/Kota" <?php if (!(strcmp("Kab/Kota", $row[14]))) {echo "SELECTED";} ?>>Kab/Kota</option>
              <option value="Provinsi" <?php if (!(strcmp("Provinsi", $row[14]))) {echo "SELECTED";} ?>>Provinsi</option>
            </select></td>
        </tr>
<tr valign="baseline">
	<!-- ajax programming -->	  
...
?> 
	<!-- ajax programming (sesuaikan name sama id nya-->
          ...
          <tr valign="baseline">
            ...
            <td><input type="submit" class="col1" onclick="MM_popupMsg('Data penduduk datang dirubah')" value="Save">
