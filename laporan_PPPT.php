...
$query_n = "SELECT * FROM laporan_pppt";
...
if ($cari != "")
	$query_n .= " WHERE nomor_laporan LIKE '%$cari%'";
...
<div class="wrapper col3">
  <div id="topnav">
	...
	<ul>
      <li><a href="cetak_laporanPPPT.php">Cetak data</a><span>data</span>
    </ul>
    <br class="clear" />
  </div>
</div>
...
<div id="output">
  ...
  <div id="container">
    <div id="content">
      <h2>Laporan Perhitungan Pertumbuhan Penduduk Total</h2>
	  </div>
    <div id="column">
      <div class="holder">
        <h2 class="title"><img src="images/cari1.png" width="44" height="46" />Laporan PPPA</h2>
        <p class="readmore">
          <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=5,0,0,0" width="147" height="34">
            <param name="movie" value="button_laporanPPPA.swf" />
            <param name="quality" value="high" />
            <embed src="button_laporanPPPA.swf" quality="high" pluginspage="http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash" type="application/x-shockwave-flash" width="147" height="34" ></embed>
          </object>
        </p>
      </div>
    </div>
	...
	<p>&nbsp;</p>
      ...
      <div align="right">
        <p><img src="images/cari1.png" width="44" height="28" border="0" />
          <input name="cari" type="text" placeholder="Nomor laporan" />
    ...
    <table border="1" cellpadding="0" cellspacing="3">
      <tr class="col1">
        <td><div align="center">Nomor laporan</div></td>
        <td><div align="center">Tanggal</div></td>
        <td><div align="center">Jumlah Penduduk</div></td>
        <td><div align="center">Jumlah Perhitungan Pertumbuhan Penduduk Total </div></td>
        <td><div align="center">Keterangan</div></td>
		<td colspan="2"><div align="center">Action</div></td>
      </tr>
      <?php do { ?>
        <tr>
          <td><div align="center"><?php echo $row_n['nomor_laporan']; ?></div></td>
          <td><div align="center"><?php echo $row_n['tanggal']; ?></div></td>
          <td><div align="center"><?php echo $row_n['jumlah_penduduk']; ?></div></td>
          <td><div align="center"><?php echo $row_n['jumlah_ppt']; ?></div></td>
          <td><div align="center"><?php echo $row_n['keterangan']; ?></div></td>
		  <td width="5%"><div align="center" onclick="MM_popupMsg('Laporan dihapus')"><a href="hapus_laporanPPPT.php?id=<?php echo $row_n['nomor_laporan']; ?>">Delete<img src="images/dell2.png" width="16" height="16" border="0"></a></div></td>
        </tr>
