...
$(document).ready(function() {
      chart1 = new Highcharts.Chart({
         chart: {
            renderTo: 'container',
            type: 'area' <!-- ini tempat model grafik jah-->	
         },   
         title: {
            text: 'Grafik Area Sensus Penduduk Desa Cimareme'
         },
         xAxis: {																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																											
...
<div class="wrapper col2">
  ...
  <marquee>
  <div align="center" class="style2 style1">- Wilujeng Sumping di Aplikasi Sensus Penduduk Desa Cimareme -</div>
  </marquee>
  </p>
</div>
<!-- ####################################################################################################### -->
