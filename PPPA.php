...
<div id="output">
  ...
  <div id="container">
    <div id="content">
      <h2>Perhitungan Pertumbuhan Penduduk Alami</h2>
      <p align="justify">Perhitungan pertumbuhan penduduk alami adalah perhitungan penduduk yang dihitung dari selisih antara jumlah kelahiran dan jumlah kematian, jumlah penduduk pendatang dan jumlah penduduk pindah.</p>
      <p>X = L &ndash; M<br />
        X = D &ndash; P</p>
      <p>X = Pertumbuhan penduduk alami <br />
L = Jumlah kelahiran penduduk <br />
M = Jumlah kematian penduduk <br />
D = Jumlah penduduk datang<br />
P = Jumlah penduduk pindah</p>
	...
	<div id="column">
      <div class="holder">
        <h2 class="title"><img src="images/cari1.png" width="44" height="46" />PPP</h2>
        <p>PPP atau perhitungan pertumbuhan penduduk adalah perhitungan penduduk yang . . .</p>
        <p class="readmore">
          <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=5,0,0,0" width="147" height="34">
            <param name="movie" value="button_PPP.swf" />
            <param name="quality" value="high" />
            <embed src="button_PPP.swf" quality="high" pluginspage="http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash" type="application/x-shockwave-flash" width="147" height="34" ></embed>
          </object>
        </p>
      </div>
    </div>
    <table width="39%" border="2"  align="center" cellpadding="3" cellspacing="10">
      <tr>
        <td colspan="2" ><div align="center" class="style5">
          <h1>Perhitungan Pertumbuhan Penduduk Alami </h1>
        </div></td>
      </tr>
      <td width="22%"><tr>
        <td><form name="form1" action="hitung_PPPA.php" method="post"></td>
      </tr>
      <tr>
        <td><div align="left">Data 1</div></td>
        <td width="78%"><div align="left">
		    <select name="input1" type="text" >
			<option value="<?php echo $totalRows_L ?>">Penduduk lahir [<?php echo $totalRows_L ?>] </option>
			<option value="<?php echo $totalRows_D ?>">Penduduk datang [<?php echo $totalRows_D ?>] </option>
			</select>
		  </div></td>
      </tr>
      <tr>
      <tr>
        ...
        <td><div align="left">
			...
			<option value="<?php echo $totalRows_M ?>">Penduduk meninggal [<?php echo $totalRows_M ?>] </option>
			<option value="<?php echo $totalRows_PP ?>">Penduduk pindah [<?php echo $totalRows_PP ?>] </option>
			</select>
			 </div></td>
      </tr>
      <tr>
        <td><div align="left">Operasi perhtiungan</div></td>
        <td><div align="left">
          <select name="hitung">
			<option value="-">-</option>
