...
$query_n = "SELECT * FROM laporan_pkp";
...
<div class="wrapper col3">
  <div id="topnav">
	...
	<ul>
      <li><a href="cetak_laporanPKP.php">Cetak data</a><span>data</span>
    </ul>
    <br class="clear" />
  </div>
</div>
...
<div id="output">
  ...
  <div id="container">
      <div id="content">
      <h2>Laporan Perhitungan Kepadatan Penduduk</h2>
	  </div>
	<p>&nbsp;</p>
	  <form>
      <div align="right">
    ...
    <table border="1" cellpadding="0" cellspacing="3">
      <tr class="col1">
        ...
        <td><div align="center">Jumlah Perhitungan Kepadatan Penduduk </div></td>
      ...
      <?php do { ?>
        <tr>
          ...
          <td><div align="center"><?php echo $row_n['jumlah_pkp']; ?></div></td>
          <td><div align="center"><?php echo $row_n['keterangan']; ?></div></td>
		  <td width="5%"><div align="center" onclick="MM_popupMsg('Laporan dihapus')"><a href="hapus_laporanPKP.php?id=<?php echo $row_n['nomor_laporan']; ?>">Delete<img src="images/dell2.png" width="16" height="16" border="0"></a></div></td>
        </tr>
