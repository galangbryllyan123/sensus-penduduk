...
$query_n = "SELECT * FROM keluarga ORDER BY nama ASC";
...
<div id="output">
  ...
  <div id="container">
    <div id="content">
      <h2>Keluarga</h2>
    <img src="images/fam.gif" />
      <p align="justify">Keluarga berasal dari bahasa Sansekerta yaitu kula dan warga &ldquo;kulawarga&rdquo; yang berarti &ldquo;anggota&rdquo; dan &ldquo;kelompok kerabat&rdquo;. Keluarga adalah  satu kelompok atau kumpulan manusia yang memiliki hubungan darah  dan hidup bersama sebagai satu kesatuan atau unit masyarakat terkecil serta dipimpin oleh seorang kepala keluarga. Keluarga inti  terdiri dari ayah, ibu dan anak.</p>
      <div align="justify">
    </div>
    </div>
	<div id="column">
      <div class="holder">
        <h2 class="title"><img src="images/cari1.png" width="44" height="46" />Kelahiran Penduduk</h2>
        <p>Kelahiran penduduk adalah proses bertambahnya jumlah penduduk di suatu wilayah . . .</p>
        <p class="readmore">
          <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=5,0,0,0" width="147" height="34">
            <param name="movie" value="button_kelahiranpendudu.swf" />
            <param name="quality" value="high" />
            <embed src="button_kelahiranpendudu.swf" quality="high" pluginspage="http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash" type="application/x-shockwave-flash" width="147" height="34" ></embed>
          </object>
        </p>
      </div>
    </div>
	...
	<p>&nbsp;</p>
	  <form>
      <div align="right">
        <p><img src="images/cari1.png" width="44" height="28" border="0" />
          <input name="cari" type="text" placeholder="NKK" />
      ...
      <table border="1" align="center" cellpadding="0" cellspacing="3">
        <tr class="col1">
          ...
          <td><div align="center">Pendidikan</div></td>
          ...
          <td><div align="center">Kewarganegaraan</div></td>
          <td><div align="center">Nama Ayah</div></td>
          <td><div align="center">Nama Ibu</div></td>
        ...
        <?php do { ?>
          <tr>
            ...
            <td><div align="center"><?php echo $row_n['pendidikan']; ?></div></td>
            <td><div align="center"><?php echo $row_n['pekerjaan']; ?></div></td>
            <td><div align="center"><?php echo $row_n['status_perkawinan']; ?></div></td>
            <td><div align="center"><?php echo $row_n['hubungan_keluarga']; ?></div></td>
            <td><div align="center"><?php echo $row_n['kewarganegaraan']; ?></div></td>
            <td><div align="center"><?php echo $row_n['nama_ayah']; ?></div></td>
            <td><div align="center"><?php echo $row_n['nama_ibu']; ?></div></td>
            <td width="5%"><div align="center"><a href="editkeluarga.php?id=<?php echo $row_n['nomor']; ?>">Edit <img src="images/edit2.png" width="16" height="26" border="0"></a></div></td>
			<td width="5%"><div align="center" onclick="MM_popupMsg('Data keluarga dihapus')"><a href="hapuskeluarga.php?id=<?php echo $row_n['NIK']; ?>">Delete<img src="images/dell2.png" width="16" height="16" border="0"></a></div></td>
          </tr>
