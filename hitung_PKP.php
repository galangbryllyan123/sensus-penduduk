...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO laporan_pkp (nomor_laporan, tanggal, jumlah_penduduk, jumlah_pkp, keterangan) VALUES (%s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['nomor_laporan'], "int"),
                       GetSQLValueString($_POST['tanggal'], "date"),
                       GetSQLValueString($_POST['jumlah_penduduk'], "int"),
                       GetSQLValueString($_POST['jumlah_pkp'], "int"),
                       GetSQLValueString($_POST['keterangan'], "text"));

  mysql_select_db($database_koneksi, $koneksi);
  $Result1 = mysql_query($insertSQL, $koneksi) or die(mysql_error());

  $insertGoTo = "laporan_PKP.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<input name="input1" type="text" class="col7" value="<?php
	...
	<p align="left">&nbsp;</p>
    <h1 align="center">Laporan Perhitungan Kepadatan Penduduk</h1>
    <form method="post" name="form1" action="<?php echo $editFormAction; ?>">
      <table align="center">
        <tr valign="baseline">
          <td width="25%" align="right" nowrap><div align="left">Nomor laporan</div></td>
          <td width="75%"><input type="text" name="nomor_laporan" value="" placeholder="Nomor laporan" size="25"></td>
        </tr>
        <tr valign="baseline">
        ...
        <tr valign="baseline">
          <td nowrap align="right"><div align="left">Perhitungan Kepadatan Penduduk </div></td>
          <td><input name="jumlah_pkp" type="text" class="col7" value="<?php
 	 $pertama = $_POST['input1'] ;
	 $kedua = $_POST['input2'] ;
 	 $operator = $_POST['hitung'] ;
