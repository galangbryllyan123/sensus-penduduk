...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO kelahiranpenduduk (nomor, NSKL, NKK, alamat, nama, tempat_lahir, tanggal_lahir, waktu_lahir, jenis_kelamin, agama) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['nomor'], "int"),
                       GetSQLValueString($_POST['NSKL'], "int"),
                       ...
                       GetSQLValueString($_POST['waktu_lahir'], "date"),
  ...
  $insertGoTo = "kelahiran_penduduk.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<title>Tambah kelahiran penduduk</title>
	...
	<form method="post" name="form1" action="<?php echo $editFormAction; ?>">
      <table align="center">
        <tr valign="baseline">
          ...
          <td width="78%"><input type="text" name="NSKL" value="" size="25" placeholder="Nomor Surat Keterangan Lahir" maxlength="25"></td>
        </tr>
<tr valign="baseline">
	<!-- ajax programming -->	  
        <?php  
	...
	<!-- ajax programming (sesuaikan name sama id nya-->
        ...
        <tr valign="baseline">
          ...
          <td><p>&nbsp;
            ...
            <p><input type="text" name="nama" value="" size="32" placeholder="Nama lengkap" maxlength="40"></p></td>
        </tr>
        <tr valign="baseline">
        ...
        <tr valign="baseline">
          ...
          <td><input type="time" name="waktu_lahir" value="" size="32"></td>
        </tr>
        <tr valign="baseline">
        ...
        <tr valign="baseline">
          ...
          <td><input name="submit" type="submit" class="col1" onclick="MM_popupMsg('Data penduduk lahir ditambahkan')" value="Save" />
