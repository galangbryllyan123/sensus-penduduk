...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO pendudukpindah (nomor, NSKP, NKK, NIK, nama, tempat_lahir, tanggal_lahir, jenis_kelamin, alamat, hubungan_keluarga, alasan_pindah, alamat_pindah, tanggal_pindah, klasifikasi_pindah) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['nomor'], "int"),
                       GetSQLValueString($_POST['NSKP'], "int"),
                       ...
                       GetSQLValueString($_POST['alasan_pindah'], "text"),
                       GetSQLValueString($_POST['alamat_pindah'], "text"),
                       GetSQLValueString($_POST['tanggal_pindah'], "date"),
                       GetSQLValueString($_POST['klasifikasi_pindah'], "text"));

  mysql_select_db($database_koneksi, $koneksi);
  $Result1 = mysql_query($insertSQL, $koneksi) or die(mysql_error());

  $insertGoTo = "penduduk_pindah.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<title>Tambah penduduk pindah</title>
    ...
    <form method="post" name="form1" action="<?php echo $editFormAction; ?>">
      <table align="center">
        ...
        <tr valign="baseline">
          ...
          <td width="74%"><input type="text" name="NSKP" value="" size="25" placeholder="Nomor Surat Keterangan Pindah" maxlength="25"></td>
        </tr>
        <tr valign="baseline">
...
<tr valign="baseline">
        ...
        <tr valign="baseline">
          ...
          <td><input type="text" name="alasan_pindah" value="" size="32" placeholder="Alasan pindah" maxlength="50"></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right" valign="top"><div align="left">Alamat pindah</div></td>
          <td><textarea name="alamat_pindah" cols="50" rows="5" placeholder="Alamat pindah"></textarea></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right"><div align="left">Tanggal pindah</div></td>
          <td><input type="date" name="tanggal_pindah" value="" size="32"></td>
        </tr>
        <tr valign="baseline">
        ...
        <tr valign="baseline">
          ...
          <td><input name="Submit" type="submit" class="col1" onclick="MM_popupMsg('Data penduduk pindah ditambahkan')" value="Save">
