...
<div id="output">
  ...
  <div id="container">
    <div id="content">
      <h2>Perangkat Desa Cimareme</h2>
	  <p align="justify">Perangkat Desa adalah unsur pelaku desa, orang yang bertugas menjalankan kegiatan operasional desa sesuai dengan tugasnya untuk mencapai tujuan.</p>
	  <p align="justify">&nbsp;</p>
    </div>
	<div id="column">
      <div class="holder">
        <h2 class="title"><img src="images/cari1.png" width="44" height="46" />Penduduk</h2>
        <p>Penduduk adalah orang  - orang yang berada di dalam suatu wilayah yang terikat oleh aturan - aturan  yang berlaku dan saling berinteraksi . . .</p>
        <p class="readmore">
          <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=5,0,0,0" width="147" height="34">
            <param name="movie" value="button_penduduk.swf" />
            <param name="quality" value="high" />
            <embed src="button_penduduk.swf" quality="high" pluginspage="http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash" type="application/x-shockwave-flash" width="147" height="34" ></embed>
          </object>
        </p>
      </div>
    </div>
    <p>&nbsp;</p>
    <p align="center"><embed src="dokumen/Data Perangkat.pdf" type="application/pdf" width="500" height="600"/></p>
  </div>
</div>
<!-- ####################################################################################################### -->
<div align="center">
