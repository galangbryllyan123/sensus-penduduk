...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO laporan_ppp (nomor_laporan, tanggal, jumlah_penduduk, jumlah_pp, keterangan) VALUES (%s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['nomor_laporan'], "int"),
                       GetSQLValueString($_POST['tanggal'], "date"),
                       GetSQLValueString($_POST['jumlah_penduduk'], "int"),
                       GetSQLValueString($_POST['jumlah_pp'], "int"),
                       GetSQLValueString($_POST['keterangan'], "text"));

  mysql_select_db($database_koneksi, $koneksi);
  $Result1 = mysql_query($insertSQL, $koneksi) or die(mysql_error());

  $insertGoTo = "laporan_PPP.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<div id="output">
  ...
  <div id="container">
    ...
    <p align="left">&nbsp;</p>
    <h1 align="center">Laporan Perhitungan Pertumbuhan Penduduk</h1>
    <form method="post" name="form1" action="<?php echo $editFormAction; ?>">
      <table align="center">
        <tr valign="baseline">
          <td width="27%" align="right" nowrap><div align="left">Nomor laporan</div></td>
          <td width="73%"><input type="text" name="nomor_laporan" value="" size="25" placeholder="Nomor laporan" maxlength="15"></td>
        </tr>
        <tr valign="baseline">
        ...
        <tr valign="baseline">
          <td nowrap align="right"><div align="left">Perhitungan Pertumbuhan Penduduk </div></td>
          <td><input name="jumlah_pp" type="text" class="col7" value="<?php
 	 $pertama = $_POST['input1'] ;
	 $kedua = $_POST['input2'] ;
 	 $operator = $_POST['hitung'] ;
...
<div class="wrapper col6">
  <div id="footer">
    ...
    <div class="footbox">
      <h2 class="style4 style6">Pertumbuhan penduduk</h2>
      <ul>
        <li><a href="kelahiran_penduduk.php">Kelahiran penduduk</a></li>
        <li><a href="kematian_penduduk.php">Kematian penduduk</a></li>
      </ul>
    ...
    <div class="footbox">
      <h2 class="style4 style6">Data Master</h2>
      <ul>
        <li><a href="penduduk.php">Penduduk</a></li>
        <li><a href="keluarga.php">Keluarga</a></li>
	  </ul>
