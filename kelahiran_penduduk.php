...
$query_n = "SELECT * FROM kelahiranpenduduk ORDER BY NSKL ASC";
...
<title>Kelahiran penduduk</title>
...
<div id="output">
  ...
  <div id="container">
    <div id="content">
      <h2>Kelahiran Penduduk</h2>
<img src="images/baby_animation.gif" width="94" height="104" />
      <p align="justify">Kelahiran adalah hasil reproduksi yang nyata dari seorang wanita. Kelahiran penduduk adalah proses bertambahnya jumlah penduduk di suatu wilayah dari hasil perkawinan seorang laki - laki dengan seorang perempuan.</p>
      <div align="justify">
	</div>
    </div>
	<div id="column">
      <div class="holder">
        <h2 class="title"><img src="images/cari1.png" width="44" height="46" />Kematian Penduduk</h2>
        <p>Kematian penduduk adalah proses alami yang terjadi pada semua mahluk hidup yang bernyawa . . .</p>
        <p class="readmore">
          <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=5,0,0,0" width="147" height="34">
            <param name="movie" value="button_kematianpenduduk.swf" />
            <param name="quality" value="high" />
            <embed src="button_kematianpenduduk.swf" quality="high" pluginspage="http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash" type="application/x-shockwave-flash" width="147" height="34" ></embed>
          </object>
        </p>
      </div>
    </div>
	...
	<form>
      <div align="right"><img src="images/cari1.png" width="44" height="28" border="0" />
          <input name="cari" type="text" placeholder="NSKL" />
    ...
    <table border="1" cellpadding="0" cellspacing="3">
      ...
      <?php do { ?>
        <tr>
          <td><div align="center"><?php echo $row_n['NSKL']; ?></div></td>
          ...
          <td><div align="center"><?php echo $row_n['waktu_lahir']; ?></div></td>
          <td><div align="center"><?php echo $row_n['jenis_kelamin']; ?></div></td>
          <td><div align="center"><?php echo $row_n['agama']; ?></div></td>
          <td width="5%"><div align="center"><a href="editkelahiranpenduduk.php?id=<?php echo $row_n['nomor']; ?>">Edit <img src="images/edit2.png" width="16" height="26" border="0"></a></div></td>
			<td width="5%"><div align="center" onclick="MM_popupMsg('Data kelahiran penduduk dihapus')"><a href="hapuskelahiran_penduduk.php?id=<?php echo $row_n['NSKL']; ?>" >Delete<img src="images/dell2.png" width="16" height="16" border="0"></a></div></td>
        </tr>
