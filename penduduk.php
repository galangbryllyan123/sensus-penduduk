...
$query_n = "SELECT * FROM penduduk ORDER BY nama ASC";
...
<div id="output">
  ...
  <div id="container">
    <div id="content">
      <h2>Penduduk</h2>
      <img class="imgl" src="images/pengertian penduduk dan warga negara.jpg" alt="" width="254" height="143" />
      <p align="justify">Penduduk adalah orang - orang yang berada di dalam suatu wilayah yang terikat oleh aturan - aturan yang berlaku dan saling berinteraksi. Dalam ilmu sosiologi,  penduduk adalah sekumpulan manusia yang menempati wilayah geografi tertentu.</p>
      <p align="justify">&nbsp;</p>
      <p align="justify">&nbsp;</p>
      <p align="justify">&nbsp;</p>
      <p align="justify">Penduduk bisa didefinisikan menjadi 2, yaitu sebagai berikut :</p>
      <p align="justify">1. Orang yang tinggal di  daerah tersebut.</p>
      <p align="justify">2.	 Orang yang secara  hukum berhak tinggal di daerah tersebut.</p>
      <div align="justify">
    </div>
    </div>
	<div id="column">
      <div class="holder">
        <h2 class="title"><img src="images/cari1.png" width="44" height="46" />Keluarga</h2>
        <p>Keluarga adalah  satu kelompok atau kumpulan manusia yang hidup bersama . . .</p>
        <p class="readmore">
          <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=5,0,0,0" width="147" height="34">
            <param name="movie" value="button_keluarga.swf" />
            <param name="quality" value="high" />
            <embed src="button_keluarga.swf" quality="high" pluginspage="http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash" type="application/x-shockwave-flash" width="147" height="34" ></embed>
          </object>
        </p>
      </div>
    </div>
	...
	<form>
      <div align="right"><img src="images/cari1.png" width="44" height="28" border="0" />
          <input name="cari" type="text" placeholder="NIK" />
    ...
    <table border="1" cellpadding="0" cellspacing="3">
      ...
      <?php do { ?>
        <tr>
		  ...
		  <td width="5%"><div align="center"><a href="editpenduduk.php?id=<?php echo $row_n['nomor']; ?>">Edit <img src="images/edit2.png" width="16" height="26" border="0"></a></div></td>
          <td width="5%"><div align="center" onclick="MM_popupMsg('Data penduduk dihapus')"><a href="hapuspenduduk.php?id=<?php echo $row_n['NIK']; ?>">Delete<img src="images/dell2.png" width="16" height="16" border="0"></a></div></td>
        </tr>
