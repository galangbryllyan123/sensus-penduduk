...
<div id="output">
  ...
  <div id="container">
    <div id="content">
      <h2>Perhitungan Pertumbuhan Penduduk</h2>
      <p align="justify">Perhitungan pertumbuhan penduduk adalah perhitungan penduduk yang dihitung dari jumlah kelahiran dan jumlah kematian. Perhitungan pertumbuhan penduduk ini dinyatakan  dengan persen ( % ). </p>
      <p align="justify">X = ( ( L - M ) : S ) &times; 100%</p>
      <p>X = Pertumbuhan penduduk<br />
        S = Jumlah penduduk asli <br />
        L = Jumlah kelahiran penduduk<br />
        M = Jumlah kematian penduduk </p>
      <p align="justify">&nbsp;</p>
      <div align="justify">
    </div>
	</div>
	<div id="column">
      <div class="holder">
        <h2 class="title"><img src="images/cari1.png" width="44" height="46" />PPRP</h2>
        <p>PPRP atau perhitungan perpindahan penduduk adalah perhitungan penduduk yang . . .</p>
        <p class="readmore">
          <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=5,0,0,0" width="147" height="34">
            <param name="movie" value="button_PPRP.swf" />
            <param name="quality" value="high" />
            <embed src="button_PPRP.swf" quality="high" pluginspage="http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash" type="application/x-shockwave-flash" width="147" height="34" ></embed>
          </object>
        </p>
      </div>
    </div>
    <table width="39%" border="2"  align="center" cellpadding="3" cellspacing="10">
      <tr>
        <td colspan="2" ><div align="center" class="style5">
          <h1>Perhitungan Pertumbuhan Penduduk</h1>
        </div></td>
      </tr>
      <tr>
        <td><form name="form1" action="hitungkurang_PPP.php" method="post"></td>
      </tr>
      <tr>
        <td width="21%"><div align="left">Penduduk lahir </div></td>
        <td width="79%"><input name="input1" type="text" class="col7" value="<?php echo $totalRows_L ?>" readonly='readonly' size="3"></td>
      </tr>
      <tr>
        <td width="21%"><div align="left">Penduduk meninggal </div></td>
        <td width="79%"><input name="input2" type="text" class="col7" value="<?php echo $totalRows_M ?>" readonly='readonly' size="3"></td>
      </tr>
      <tr>
