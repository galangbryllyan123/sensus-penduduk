...
$query_n = "SELECT * FROM kematianpenduduk";
  ...
  <div id="topnav">
    <ul>
      <li><a href="kematian_penduduk.php">Kematian Penduduk</a><span>data</span>
        <ul>
          <li><a href="tambahkematian_penduduk.php">Tambah kematian penduduk</a></li>
...
<div id="container">
    <div id="content">
      ...
      <p><img src="images/21_korban_meninggal_saat_pembagian_zakat_di_pasuruan.jpg" width="190" height="120" /></p>
      <p align="justify">Kematian adalah keadaan menghilangnya semua tanda – tanda kehidupan secara permanen yang bisa terjadi setiap saat setelah kelahiran hidup. Kematian adalah proses alami yang terjadi pada semua mahluk hidup yang bernyawa. Kematian penduduk adalah proses berkurkangnya jumlah penduduk di suatu wilayah.</p>
      <div align="justify">
	</div>
    </div>
	<div id="column">
      <div class="holder">
        <h2 class="title"><img src="images/cari1.png" width="44" height="46" />Penduduk datang </h2>
        <p>Penduduk datang  adalah pergerakan penduduk yang menyebabkan bertambahnya . . .</p>
        <p class="readmore">
          <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=5,0,0,0" width="147" height="34">
            <param name="movie" value="button_pendudukdatang.swf" />
            <param name="quality" value="high" />
            <embed src="button_pendudukdatang.swf" quality="high" pluginspage="http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash" type="application/x-shockwave-flash" width="147" height="34" ></embed>
          </object>
        </p>
      </div>
    </div>
	...
	<form>
      <div align="right"><img src="images/cari1.png" width="44" height="28" border="0" />
          <input name="cari" type="text" placeholder="NSKM" />
    ...
    <table border="1" cellpadding="0" cellspacing="3">
      <tr class="col1">
        <td><div align="center">NSKM</div></td>
        ...
        <td><div align="center">Tempat meninggal</div></td>
        <td><div align="center">Tanggal meninggal</div></td>
        <td><div align="center">Waktu meninggal</div></td>
        <td><div align="center">Sebab meninggal</div></td>
		<td colspan="2"><div align="center">Action</div></td>
      </tr>
      <?php do { ?>
        <tr>
          <td><div align="center"><?php echo $row_n['NSKM']; ?></div></td>
          ...
          <td><div align="center"><?php echo $row_n['tempat_meninggal']; ?></div></td>
          <td><div align="center"><?php echo $row_n['tanggal_meninggal']; ?></div></td>
          <td><div align="center"><?php echo $row_n['waktu_meninggal']; ?></div></td>
          <td><div align="center"><?php echo $row_n['sebab_meninggal']; ?></div></td>
		  <td width="5%"><div align="center"><a href="editkematian_penduduk.php?id=<?php echo $row_n['nomor']; ?>">Edit <img src="images/edit2.png" width="16" height="26" border="0"></a></div></td>
          <td width="5%"><div align="center" onclick="MM_popupMsg('Data kematian penduduk dihapus')"><a href="hapuskematian_penduduk.php?id=<?php echo $row_n['NSKM']; ?>">Delete<img src="images/dell2.png" width="16" height="16" border="0" ></a></div></td>
        </tr>
