...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO laporan_pppa (nomor_laporan, tanggal, jumlah_penduduk, jumlah_PPPA, Keterangan) VALUES (%s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['nomor_laporan'], "int"),
                       GetSQLValueString($_POST['tanggal'], "date"),
                       GetSQLValueString($_POST['jumlah_penduduk'], "int"),
                       GetSQLValueString($_POST['jumlah_PPPA'], "int"),
                       GetSQLValueString($_POST['Keterangan'], "text"));

  mysql_select_db($database_koneksi, $koneksi);
  $Result1 = mysql_query($insertSQL, $koneksi) or die(mysql_error());

  $insertGoTo = "laporan_PPPA.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<div id="output">
  ...
  <div id="container">
	...
	<p align="left">&nbsp;</p>
    <h1 align="center">Laporan Perhitungan Pertumbuhan Penduduk Alami</h1>
    <form method="post" name="form1" action="<?php echo $editFormAction; ?>">
      <table align="center">
        ...
        <tr valign="baseline">
          <td nowrap align="right"><div align="left">Perhitungan Pertumbuhan Penduduk Alami</div></td>
          <td><input name="jumlah_PPPA" type="text" class="col7" value="<?php
 	 $pertama = $_POST['input1'] ;
	 $kedua = $_POST['input2'] ;
 	 $operator = $_POST['hitung'] ;
