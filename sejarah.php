...
<div id="output">
  ...
  <div id="container">
    <div id="content">
      <h2>Sejarah singkat Desa Cimareme </h2>
      <img class="imgl" src="images/Pohon mareme.jpg" alt="" width="125" height="125" />
      <p align="justify">Desa Cimareme adalah desa yang terletak Kecamatan Ngamprah, Kabupaten Bandung Barat, Provinsi Jawa Barat, Indonesia. Cimareme dalam bahasa sunda berasal dari kata Ci yang berarti Cai dan Mareme yang berarti nama sejenis pohon yang daunnya biasa dimakan sebagai lalapan sebagaimana tradisi orang sunda. Pohon Mareme tersebut tumbuh di halaman perkantoran Desa Cimareme dan merupakan satu - satunya pohon mareme yang berada di wilayah Desa Cimareme.</p>
    </div>
	<div id="column">
      <div class="holder">
        <h2 class="title"><img src="images/cari1.png" width="44" height="46" />Visi dan Misi Desa Cimareme</h2>
        <p>Terbangunnya tata kelola pemerintahan desa yang baik, berdisiplin, bersih dan agamis . . .</p>
        <p class="readmore">
          <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=5,0,0,0" width="147" height="34">
            <param name="movie" value="button_visimisi.swf" />
            <param name="quality" value="high" />
            <embed src="button_visimisi.swf" quality="high" pluginspage="http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash" type="application/x-shockwave-flash" width="147" height="34" ></embed>
          </object>
        </p>
      </div>
    </div>
