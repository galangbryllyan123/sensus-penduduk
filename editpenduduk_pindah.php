...
$query_r = "SELECT * FROM pendudukpindah WHERE nomor = '$nomor'";
...
<title>Edit penduduk pindah</title>
...
<div id="output">
  ...
  <div id="container">
    <div id="content">
      <h2>Edit Penduduk Pindah </h2>
    </div>
	  <p>&nbsp;</p>
	  <p>&nbsp;</p>
	 <form action=update_penduduk_datang.php method="POST" name="formedit" id="formedit">
     <input name="nomor" type="hidden" value="<?php echo $row[0];?>"> 
      <form method="post" name="form1" action="<?php echo $editFormAction; ?>">
        <table align="center">
          <tr valign="baseline">
        <td width="26%" align="right" nowrap><div align="left">NSKP</div></td>
        <td width="74%"><div align="left"><?php echo $row[1]; ?></div></td>
      </tr>
	  <tr valign="baseline">
...
<tr valign="baseline">
            <td nowrap align="right"><div align="left">
              <h1>Data Penduduk Pindah</h1>
              <p>NIK</p>
            </div></td>
            <td><p>&nbsp;
              </p>
              <p><input name="NIK" type="text" class="col7" id='NIK' value="<?php echo $row[3]; ?>" size="25" readonly='readonly' maxlength="25" placeholder="NIK" /></td>
	    </tr>
        <tr valign="baseline">
          <td nowrap align="right"><div align="left">Nama</div></td>
          <td><input name="nama" type="text" class="col7" id='nama' value="<?php echo $row[4]; ?>" size="32" readonly='readonly' maxlength="40" placeholder="Nama lengkap"></td>
          </tr>
        <tr valign="baseline">
          <td nowrap align="right"><div align="left">Tempat lahir</div></td>
          <td><input name="tempat_lahir" type="text" class="col7" id='tempat_lahir' value="<?php echo $row[5]; ?>" size="16" readonly='readonly' maxlength="20" placeholder="Tempat lahir"></td>
        <tr valign="baseline">
          <td nowrap align="right"><div align="left">Tanggal lahir</div></td>
          <td><input name="tanggal_lahir" type="date" class="col7" id='tanggal_lahir' value="<?php echo $row[6]; ?>" size="32" readonly='readonly'></td>
          </tr>
        <tr valign="baseline">
          <td nowrap align="right"><div align="left">Jenis kelamin</div></td>
          <td><input name="jenis_kelamin" type="text" class="col7" id='jenis_kelamin' value="<?php echo $row[7]; ?>" size="16" readonly='readonly' maxlength="20" placeholder="Jenis kelamin"></td>
			</tr>
		<tr valign="baseline">
            <td nowrap align="right"><div align="left" class="style5">Alamat</div></td>
            <td><textarea name="alamat" cols="50" rows="5" class="col7" id='alamat' readonly='readonly' placeholder="Alamat tempat tinggal"><?php echo $row[8]; ?></textarea></td>
        <tr valign="baseline">
          <td nowrap align="right"><div align="left">Hubungan keluarga</div></td>
          <td><input type="text" name="hubungan_keluarga" value="<?php echo $row[9]; ?>" size="25" placeholder="Hubungan keluarga" maxlength="20"></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right"><div align="left">Alasan pindah</div></td>
          <td><input type="text" name="alasan_pindah" value="<?php echo $row[10]; ?>" size="32" placeholder="Alasan pindah" maxlength="50"></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right" valign="top"><div align="left">Alamat pindah</div></td>
          <td><textarea name="alamat_pindah" cols="50" rows="5" placeholder="Alamat pindah"><?php echo $row[11]; ?></textarea></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right"><div align="left">Tanggal pindah</div></td>
          <td><input type="date" name="tanggal_pindah" value="<?php echo $row[12]; ?>" size="32"></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right"><div align="left">Klasifikasi pindah</div></td>
          <td><select name="klasifikasi_pindah">
              <option value="Kecamatan" <?php if (!(strcmp("Kecamatan", $row[13]))) {echo "SELECTED";} ?>>Kecamatan</option>
              <option value="Kab/Kota" <?php if (!(strcmp("Kab/Kota", $row[13]))) {echo "SELECTED";} ?>>Kab/Kota</option>
              <option value="Provinsi" <?php if (!(strcmp("Provinsi", $row[13]))) {echo "SELECTED";} ?>>Provinsi</option>
            </select></td>
        </tr>
      </tr>
        <tr valign="baseline">
...
?> 
	<!-- ajax programming (sesuaikan name sama id nya-->	  
          ...
          <tr valign="baseline">
            ...
            <td><input type="submit" class="col1" onclick="MM_popupMsg('Data penduduk pindah dirubah')" value="Save">
