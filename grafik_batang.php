...
$(document).ready(function() {
      chart1 = new Highcharts.Chart({
         chart: {
            renderTo: 'container',
            type: 'bar' <!-- ini tempat model grafik jah-->	
         },   
         title: {
            text: 'Grafik Batang Sensus Penduduk Desa Cimareme'
         },
         xAxis: {																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																											
...
<div class="wrapper col2">
  ...
  <marquee>
  <div align="center" class="style1 style3">- Wilujeng Sumping di Aplikasi Sensus Penduduk Desa Cimareme -</div>
  </marquee>
  </p>
</div>
<!-- ####################################################################################################### -->
