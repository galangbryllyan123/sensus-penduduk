...
mysql_select_db($database_koneksi, $koneksi);
$query_n = "SELECT * FROM pendudukdatang";
...
<div id="output">
  ...
  <div id="container">
    <div id="content">
      ...
      <img src="images/9pPIWQuJ1r.jpg" width="262" height="143" />
      <p align="justify">Penduduk datang adalah proses pergerakan penduduk yang menyebabkan bertambahnya jumlah penduduk di Desa. Penduduk datang dapat juga disebut dengan Transmigrasi. Transmigrasi berasal dari bahasa Belanda yang berarti transmigratie. Transmigrasi adalah suatu program yang dibuat oleh pemerintah Indonesia untuk memindahkan penduduk dari suatu daerah yang padat penduduk ( kota ) ke daerah lain ( desa ) di dalam wilayah Indonesia.</p>
    <div align="justify">
    </div>
    </div>
	<div id="column">
      <div class="holder">
        <h2 class="title"><img src="images/cari1.png" width="44" height="46" />Penduduk Pindah</h2>
        <p>Penduduk pindah  adalah pergerakan penduduk yang menyebabkan berkurangnya . . .</p>
        <p class="readmore">
          <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=5,0,0,0" width="147" height="34">
            <param name="movie" value="button_pendudukpindah.swf" />
            <param name="quality" value="high" />
            <embed src="button_pendudukpindah.swf" quality="high" pluginspage="http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash" type="application/x-shockwave-flash" width="147" height="34" ></embed>
          </object>
        </p>
      </div>
    </div>
	...
	<form>
      <div align="right"><img src="images/cari1.png" width="44" height="28" border="0" />
          <input name="cari" type="text" placeholder="NSKD" />
    ...
    <table border="1" cellpadding="0" cellspacing="3">
      ...
      <?php do { ?>
        <tr>
		  ...
		  <td width="5%"><div align="center"><a href="editpenduduk_datang.php?id=<?php echo $row_n['nomor']; ?>">Edit <img src="images/edit2.png" width="16" height="26" border="0"></a></div></td>
          <td width="5%"><div align="center" onclick="MM_popupMsg('Data penduduk datang dihapus')"><a href="hapuspenduduk_datang.php?id=<?php echo $row_n['NSKD']; ?>">Delete<img src="images/dell2.png" width="16" height="16" border="0" ></a></div></td>
        </tr>
