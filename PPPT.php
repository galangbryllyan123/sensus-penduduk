...
<div id="output">
  ...
  <div id="container">
    <div id="content">
      <h2>Perhitungan Pertumbuhan Penduduk Total</h2>
      <p align="justify">Perhitungan pertumbuhan penduduk total adalah perhitungan penduduk  yang dihitung dari penambahan dan pengurangan jumlah penduduk asli dengan jumlah kelahiran penduduk dan jumlah kematian penduduk, jumlah penduduk pendatang dan jumlah  penduduk pindah.</p>
      <p>X = S + L<br />
        X = S &ndash; M<br />
        X = S + D<br />
        X = S &ndash; P</p>
      <p>X = Pertumbuhan penduduk total<br />
S = Jumlah penduduk asli <br />
L = Jumlah kelahiran <br />
M = Jumlah kematian<br />
D = Jumlah penduduk datang<br />
	...
	<div id="column">
      <div class="holder">
        <h2 class="title"><img src="images/cari1.png" width="44" height="46" />PPPA</h2>
        <p>PPPA atau perhitungan pertumbuhan penduduk alami adalah perhitungan penduduk . . .</p>
        <p class="readmore">
          <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=5,0,0,0" width="147" height="34">
            <param name="movie" value="button_PPPA.swf" />
            <param name="quality" value="high" />
            <embed src="button_PPPA.swf" quality="high" pluginspage="http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash" type="application/x-shockwave-flash" width="147" height="34" ></embed>
          </object>
        </p>
      </div>
    </div>
    <table width="39%" border="2"  align="center" cellpadding="3" cellspacing="10">
      <tr>
        <td colspan="2" ><div align="center" class="style5">
          <h1>Perhitungan Pertumbuhan Penduduk Total </h1>
        </div></td>
      </tr>
      <tr>
        <td><form name="form1" action="hitung_PPPT.php" method="post"></td>
      </tr>
      <tr>
