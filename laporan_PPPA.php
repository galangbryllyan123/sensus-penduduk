...
$query_n = "SELECT * FROM laporan_pppa";
...
<div class="wrapper col3">
  <div id="topnav">
	...
	<ul>
      <li><a href="cetak_laporanPPPA.php">Cetak data</a><span>data</span>
    </ul>
    <br class="clear" />
  </div>
</div>
...
<div id="output">
  ...
  <div id="container">
    <div id="content">
      <h2>Laporan Perhitungan Pertumbuhan Penduduk Alami</h2>
	  </div>
    <div id="column">
      <div class="holder">
        <h2 class="title"><img src="images/cari1.png" width="44" height="46" />Laporan PPP</h2>
        <p class="readmore">
          <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=5,0,0,0" width="147" height="34">
            <param name="movie" value="button_laporanPPP.swf" />
            <param name="quality" value="high" />
            <embed src="button_laporanPPP.swf" quality="high" pluginspage="http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash" type="application/x-shockwave-flash" width="147" height="34" ></embed>
          </object>
        </p>
      </div>
    </div>
    ...
    <table border="1" cellpadding="0" cellspacing="3">
      <tr class="col1">
        ...
        <td><div align="center">Jumlah Perhitungan Pertumbuhan Penduduk Alami </div></td>
      ...
      <?php do { ?>
        <tr>
          ...
          <td><div align="center"><?php echo $row_n['jumlah_PPPA']; ?></div></td>
          <td><div align="center"><?php echo $row_n['Keterangan']; ?></div></td>
		  <td width="5%"><div align="center" onclick="MM_popupMsg('Laporan dihapus')"><a href="hapus_laporanPPPA.php?id=<?php echo $row_n['nomor_laporan']; ?>">Delete<img src="images/dell2.png" width="16" height="16" border="0"></a></div></td>
        </tr>
