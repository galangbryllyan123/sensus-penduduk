...
<div id="output">
  ...
  <div id="container">
    <div id="content">
	  ...
	  <p>&nbsp;</p>
	  <p>&nbsp;</p>
	<form action=update_penduduk.php method="POST" name="formedit" enctype="multipart/form-data" id="formedit">
     <input name="nomor" type="hidden" value="<?php echo $row[0];?>"> 
      <form method="post" name="form1" action="<?php echo $editFormAction; ?>">
        ...
        <td><div align="left"><?php echo $row[1]; ?></div></td>
		  ...
		  <tr valign="baseline">
            ...
            <td><input name="nama" type="text" id="nama" value="<?php echo $row[2];?>" size="32" /></td>
          </tr>
          <tr valign="baseline">
            <td nowrap align="right"><div align="left">Tempat lahir</div></td>
            <td><input name="tempat_lahir" type="text" id="tempat_lahir" value="<?php echo $row[3];?>" size="32" /></td>
          </tr>
          <tr valign="baseline">
            <td nowrap align="right"><div align="left">Tanggal lahir</div></td>
            <td><input name="tanggal_lahir" type="date" id="tanggal_lahir" value="<?php echo $row[4];?>" size="32" /></td>
          </tr>
          <tr valign="baseline">
        ...
        <td valign="baseline"><div align="left">
          <table>
            <tr>
              <td><input type="radio" name="jenis_kelamin" value="Laki - laki" <?php if (!(strcmp($row[5],"Laki - laki"))) {echo "CHECKED";} ?>>
                Laki - laki</td>
                </tr>
            <tr>
              <td><input type="radio" name="jenis_kelamin" value="Perempuan" <?php if (!(strcmp($row[5],"Perempuan"))) {echo "CHECKED";} ?>>
                Perempuan</td>
                </tr>
          </table>
        </div></td>
	  ...
	  <tr valign="baseline">
        ...
        <td><div align="left">
          <textarea name="alamat" cols="50" rows="5"><?php echo $row[6]; ?></textarea>
        </div></td>
      </tr>
	  <tr valign="baseline">
        ...
        <td><div align="left">
          <select name="agama">
            <option value="Islam" <?php if (!(strcmp("Islam", $row[7]))) {echo "SELECTED";} ?>>Islam</option>
            <option value="Katolik" <?php if (!(strcmp("Katolik", $row[7]))) {echo "SELECTED";} ?>>Katolik</option>
            <option value="Protestan" <?php if (!(strcmp("Protestan", $row[7]))) {echo "SELECTED";} ?>>Protestan</option>
            <option value="Hindu" <?php if (!(strcmp("Hindu", $row[7]))) {echo "SELECTED";} ?>>Hindu</option>
            <option value="Budha" <?php if (!(strcmp("Budha", $row[7]))) {echo "SELECTED";} ?>>Budha</option>
            <option value="Konghucu" <?php if (!(strcmp("Konghucu", $row[7]))) {echo "SELECTED";} ?>>Konghucu</option>
          </select>
        </div></td>
      </tr>
	  <tr valign="baseline">
        ...
        <td valign="baseline"><div align="left">
          <table>
            <tr>
              <td><input type="radio" name="status_perkawinan" value="Kawin" <?php if (!(strcmp($row[8],"Kawin"))) {echo "CHECKED";} ?>>
                Kawin</td>
                </tr>
            <tr>
              <td><input type="radio" name="status_perkawinan" value="Belum kawin" <?php if (!(strcmp($row[8],"Belum kawin"))) {echo "CHECKED";} ?>>
                Belum kawin</td>
                </tr>
          </table>
        </div></td>
          ...
          <tr valign="baseline">
            ...
            <td><input name="pekerjaan" type="text" id="pekerjaan" value="<?php echo $row[9];?>" size="32" /></td>
          </tr>
          <tr valign="baseline">
        <td nowrap align="right"><div align="left">Kewarganegaraan</div></td>
        <td><div align="left">
          <select name="kewarganegaraan">
            <option value="WNI" <?php if (!(strcmp("WNI", $row[10]))) {echo "SELECTED";} ?>>WNI</option>
            <option value="WNA" <?php if (!(strcmp("WNA", $row[10]))) {echo "SELECTED";} ?>>WNA</option>
          </select>
        </div></td>
	  <tr valign="baseline">
          <td nowrap align="right"><div align="left">Foto ( ukuran maksimal = 1 MB )</div></td>
          <td><input type="file" name="foto" value="<?php echo $row[11];?>"></td>
        </tr>
      </tr>
          <tr valign="baseline">
            <td nowrap align="right"><div align="left"></div></td>
            <td><input type="submit" class="col1" onclick="MM_popupMsg('Data penduduk dirubah')" value="Save">
